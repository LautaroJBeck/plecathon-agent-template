...
- Status "requested" means the host still has to approve and nothing is paid. Say "the host still has to approve it"; do not use the word "confirmed" for it at all.
